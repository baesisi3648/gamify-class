(() => {
  ...
  function deleteAIResult(){
    ...
    image.hidden=true;
    placeholder.innerHTML='<span>✦</span><b>생성된 이미지가 여기에 나타납니다</b><small>맵은 바닥 레이어로, 오브젝트는 배경 제거 후 가져올 수 있어요.</small>';

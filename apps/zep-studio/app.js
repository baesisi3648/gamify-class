(() => {
  ...
  const state = {
    ...
    library: [], hasContent: false, saveTimer: null
  };
  ...
  function bind() {
    ...
    $('#helpButton').addEventListener('click',()=>$('#helpDialog').showModal());$('#projectName').addEventListener('input',scheduleSave);

(() => {
  ...
  function syncAIModeUI(){
    ...
    $('#aiGenerateButton').innerHTML=object?'<span>✦</span> 오브젝트 생성':layered?'<span>✦</span> 분리 맵 생성 (실험)':'<span>✦</span> 고품질 맵 생성';
  }
